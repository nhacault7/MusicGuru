...
public class Dialogs
{
    ...
    public void saveFiles(LinkedList<File> sheets) {
        
        BufferedImage bImage = null;
        for (int i = 0; i < sheets.size(); i++) {
            try {
                bImage = ImageIO.read(sheets.get(i)); 
                ImageIO.write(bImage, "jpg", new File("C:\\Users\\n.hacault\\Desktop\\MusicGuru\\src\\resources\\sheets\\sheet1.jpg"));
